...
var EduCare = function(){
	...
	var dzTheme = function(){
		 ...
		 if(screenWidth < 991)
		{
			...
			jQuery('.header-style-4.mo-left .header-nav .logo-header > a > img').attr('src','images/logo3.png');
			jQuery('.header-style-4.mo-left.home-4 .header-nav .logo-header > a > img').attr('src','images/logo.png');
			jQuery('.home-2.mo-left .header-nav .logo-header > a > img').attr('src','images/logo5.png');
			jQuery('.home-5.mo-left .header-nav .logo-header > a > img').attr('src','images/logo5.png');
			jQuery('.home-9.mo-left .header-nav .logo-header > a > img').attr('src','images/logo5.png');
	...
	var headerFix = function(){
		...
		jQuery(window).on('scroll', function () {
			...
			if ($(window).scrollTop() > menu.offset().top) {
				...
				$('.home-5.header-style-5 .container > .logo-header .logo').attr('src','images/logo5.png');
			} else {
